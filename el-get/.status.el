((company-go status "installed" recipe
             (:checksum "92fcd5b7a94009078268e66101ac9e3f1c8cbb93" :name company-go :url "https://raw.githubusercontent.com/nsf/gocode/master/emacs-company/company-go.el" :type http :features
                        (company-go)
                        :after nil))
 (company-mode status "installed" recipe
               (:checksum "21357f6d6274420d0f4fda07841daf0853b4749c" :name company-mode :type github :pkgname "company-mode/company-mode" :features
                          (company)
                          :after nil))
 ...
 (exec-path-from-shell status "installed" recipe
                       (:checksum "5836fb1656493be4152e8f20b5b0ec3d49ca2787" :name exec-path-from-shell :features
 ...
 (go-mode status "installed" recipe
          (:checksum "259110bfd7acb62196b09487d0883429b444bf1b" :name go-mode :features
                     (go-mode)
 ...
 (init-loader status "installed" recipe
              (:checksum "287da99eadfa3dd85492506db43d68324069b593" :name init-loader :after nil :website "https://github.com/emacs-jp/init-loader" :description "It enables you to categorize your configurations and separate them into multiple files." :type github :pkgname "emacs-jp/init-loader"))
 ...
 (seq status "installed" recipe
      (:name seq :description "Sequence manipulation library for Emacs" :builtin "25" :type github :pkgname "NicolasPetton/seq.el" :checksum "cdd5d2d24a8dc12ecbd4930193a374f2d0c35901"))
 (yaml-mode status "installed" recipe
            (:checksum "f378589912af8731428198ef57546c616d941df0" :name yaml-mode :features
                       (yaml-mode)
                       :after nil :description "Simple major mode to edit YAML file for emacs" :type github :pkgname "yoshiki/yaml-mode")))
